...
public class MapTileDownloader extends MapTileModuleProviderBase {
        ...
        protected Runnable getTileLoader() {
                return new TileLoader(mTileSource);
        };
        ...
        private class TileLoader extends MapTileModuleProviderBase.TileLoader {
                OnlineTileSourceBase mTS;
                
                public TileLoader(final OnlineTileSourceBase aTS) {
                    mTS = aTS;
                }
                ...
                public Drawable loadTile(final MapTileRequestState aState) throws CantContinueException {
                        ...
                        try {
                                ...
                                final String tileURLString = mTS.getTileURLString(tile);
                                ...
                                if (mFilesystemCache != null) {
                                        mFilesystemCache.saveFile(mTS, tile, byteStream);
                                        byteStream.reset();
                                }
                                final Drawable result = mTS.getDrawable(byteStream);
